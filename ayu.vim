...
let s:palette.tag       = {'dark': "#E51A30",  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#F071B7",  'light': "#86B300",  'mirage': "#BBE67E"}
...
let s:palette.selection = {'dark': "#840084",  'light': "#F0EEE4",  'mirage': "#343F4C"}
